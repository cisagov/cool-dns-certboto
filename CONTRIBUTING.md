...
issue](https://github.com/cisagov/cool-dns-certboto/issues) in this
...
request](https://github.com/cisagov/cool-dns-certboto/pulls), you
...
```console
cd cool-dns-certboto
pyenv virtualenv <python_version_to_use> cool-dns-certboto
pyenv local cool-dns-certboto
